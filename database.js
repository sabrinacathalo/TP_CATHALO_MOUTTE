        ...
        db.run(
            ...
            (errQuery) => {
                ...
                // Table just created, creating some rows
                    ...
                    db.run(actors, [1, 'Dwayne', 'Johnson', '02/05/1972', null]);
                    db.run(actors, [2, 'Alexandra', 'Daddario', '16/03/1986', null]);
                    db.run(actors, [3, 'Tom', 'Cruise', '03/07/1962', null]);
                    db.run(actors, [4, 'Bruce', 'Lee', '27/11/1940', '20/07/1973']);
